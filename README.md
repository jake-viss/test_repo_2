...
This is a command-line interface application for an ATM Machine that allows you to do different tasks such as deposit, withdrawal and check your account balance. 
